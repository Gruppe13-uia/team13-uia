...
<title>Norges Roforbund | Legg til Resultater</title>
<!--Ion Icons-->
...
<regform>
    <div class="regform">
        <div class="split-screen">
            ...
            <div class="dropdown">
                <button class="dropbtn">Velg Klasse type</button>
                <div class="dropdown-content">
                    <a href="AddJuniorA/AddJuniorA.html">Junior A</a>
                    <a href="AddJuniorB/AddJuniorB.html">Junior B</a>
                    <a href="AddJuniorC/AddJuniorC.html">Junior C</a>
                </div>
            </div>
            <div class="right">
                <form>
                    <section class="copy">
                        <h2>Resultater Senior</h2>
                        <div class="login-container">
                            <p>Oppleverer du problemer? <a href="#"><strong>Be om hjelp</strong></a></p>
                        </div>
                    </section>
                    <div class="input-container group">
                        <label for="group">Utøver</label>
                        <select class="option" name="group">
                            ...
                            <option>Hanne Gailis</option>
                            <option>Janis Gailis</option>
                            <option>Sebastian Baranzano</option>
                        </select>
                    </div>
                    <div class="input-container name">
                        <label for="fname">5000 Watt</label>
                        <input id="fname" name="fname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">5000 Tid</label>
                        <input id="lname" name="lname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">2000 Watt</label>
                        <input id="lname" name="lname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">2000 Tid</label>
                        <input id="lname" name="lname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">60 Watt</label>
                        <input id="lname" name="lname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">Prosent Ligg Ro</label>
                        <input id="lname" name="lname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">Prosent Knebøy</label>
                        <input id="lname" name="lname" type="text">
                    </div>

                    <button class="add-btn" type="submit">Legg til</button>
                </form>
            </div>
        </div>
    </div>
