        ...
        <div class="split-screen">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="../NewAddResults.html">Senior</a>
            ...
            <div class="right">
                <form>
                    ...
                    <div class="input-container name">
                        <label for="fname">3000 Sekunder</label>
                        <input id="fname" name="fname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">3000 Tid</label>
                    ...
                    <div class="input-container lastname">
                        <label for="lname">Antall Kroppshevinger</label>
                        <input id="lname" name="lname" type="text">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">Sargeant</label>
                        <input id="lname" name="lname" type="text">
                    </div>
