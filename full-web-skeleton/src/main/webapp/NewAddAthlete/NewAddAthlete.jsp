<!DOCTYPE html>
<%@page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" import="servlets.AddServlets.InsertNewAthleteToDb" %>
...
<title>Norges Roforbund | Legg til Utøver</title>
<!--Ion Icons-->
        ...
        <div class="split-screen">
            ...
            <div class="right">
                <form>
                    ...
                    <div class="input-container agreement">
                        <label class="checkbox-container">
                            <p>Har vedkommende samtykket til registrering?</p>
                            <div class="checkbox-container-yes">
                                <input type="checkbox">
                                <span class="checkmark">Ja</span><br>
                            </div>
                            <div class="checkbox-container-no">
                                <input type="checkbox">
                                <span class="checkmark">Nei</span>
                            </div>
                        </label>
                    </div>
