    ...
    <main>
        <section class="hero">
            <div class="container">
                <div class="main-message">
                    ...
                    <div class="cta">
                        <a href="#" class="btn">Se Testresultater</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="experience-outdoors">
            <div class="container">
                <div class="title-heading">
                    <h3>Se</h3>
                    <h1>Historiske testresultater og topplister</h1>
        ...
        <section class="instagrams">
            <div class="container">
                <!--<div class="instagram">
                    ...
                    <div class="elfsight-app-674fe55d-989b-4746-8789-1a70a8acd038"></div>
                </div>-->
            </div>
        </section>
        ...
        <section class="begin-adventure">
            <div class="container">
                ...
                <a class="btn" href="https://www.roing.no/">Tilbake til roing.no</a>
            </div>
        </section>
    </main>
