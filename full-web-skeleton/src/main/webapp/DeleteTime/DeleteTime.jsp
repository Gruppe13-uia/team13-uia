...
<title>Norges Roforbund | Slett Klubb</title>
<!--Ion Icons-->
            ...
            <div class="right">
                <form>
                    ...
                    <div class="input-container name">
                        <label for="fname">Uke</label>
                        <input id="fname" name="fname" type="number">
                    </div>
                    <div class="input-container lastname">
                        <label for="lname">År</label>
                        <input id="lname" name="lname" type="number">
                    </div>

                    <br><h3>OBS: Ved sletting av valgt Uke og År vil gjeldende paramter bli permanent fjernet fra systemet om må manuelt legges inn igjen!</h3>
