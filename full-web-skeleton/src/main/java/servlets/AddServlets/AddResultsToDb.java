...
@WebServlet(name= "AddResultsToDb", urlPatterns = {"/AddResultsToDb"})
public class AddResultsToDb extends AbstractAppServlet {
    /**
    ...
    protected void writeBody(HttpServletRequest req, PrintWriter out) {
        ...
        String Bevelighet = req.getParameter("Bevelighet");
        String Prosent_Knebøy = req.getParameter("Prosent_Knebøy");
        String Sekunder3000 = req.getParameter("3000_Sekunder");
        String Tid3000 = req.getParameter("3000_Tid");
        String Antall_Kroppshevinger = req.getParameter("Antall_Kroppshevinger");
        String Total_Score = req.getParameter("Total_Score");


        out.println(Total_Score);
        Add.addResults(Watt5000, Tid5000, Watt2000, Tid2000, Watt60, Prosent_Ligg_ro, Sargeant, Bevelighet, Prosent_Knebøy,
                Sekunder3000, Tid3000, Antall_Kroppshevinger, Total_Score, out);
