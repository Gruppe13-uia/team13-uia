...
@WebServlet(name = "InsertNewTestTypesToDb", urlPatterns = {"/InsertNewTestTypesToDb"})
public class InsertNewTestTypesToDb extends AbstractAppServlet {
    @Override
    ...
    protected void writeBody(HttpServletRequest req, PrintWriter out) {
        ...
        out.println("</form>");
//Fikse senere slik at det fungerer og Klubb blir lagt til i tabellen
    }
