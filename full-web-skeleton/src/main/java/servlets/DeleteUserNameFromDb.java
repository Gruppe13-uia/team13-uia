...
@WebServlet(name= "DeleteUserNameFromDb", urlPatterns = {"/DeleteUserNameFromDb"})
public class DeleteUserNameFromDb extends AbstractAppServlet {
    /**
    ...
    protected void writeBody(HttpServletRequest req, PrintWriter out) {
        ...
        UserRepository.deleteUser(username, out);
